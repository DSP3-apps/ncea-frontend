    ...
    hits: [
      {
        ...
        _source: {
          ...
          resourceTitleObject: {
            default: '20190731 - HI1597 - Firth of Clyde - Troon to Turnberry Point - 2m - Bathymetric Survey',
            langeng: '20190731 - HI1597 - Firth of Clyde - Troon to Turnberry Point - 2m - Bathymetric Survey',
          },
          resourceAltTitleObject: [
            {
          ...
          MD_LegalConstraintsOtherConstraintsObject: [
            {
              default: 'There are no limitations on public access to spatial data sets and services.',
              langeng: 'There are no limitations on public access to spatial data sets and services.',
  ...
  items: [
    {
      ...
      title: '20190731 - HI1597 - Firth of Clyde - Troon to Turnberry Point - 2m - Bathymetric Survey',
      ...
      ncea_catalogue_entry: '',
      host_catalogue_number: 'https://seabed.admiralty.co.ukfb8dca0f-7425-4f50-86a1-c4673b1aef88',
      host_catalogue_entry: '',
      resource_type_and_hierarchy: 'Dataset',
      ...
      resourceWebsite: `<table class="details-table">
                      <thead>
                        <tr>
                          <th width="60%">Data services and download area of interest</th>
                          <th width="10%">Link</th>
                          <th>Action</th>
                        </tr>
                      </thead><tbody><tr>
                      <td>Notifiable Disease Datasets: Additional Information</td>
                      <td>Copy Link</td>
                      <td>Open Link</td>
                    </tr></tbody></table>`,
    },
