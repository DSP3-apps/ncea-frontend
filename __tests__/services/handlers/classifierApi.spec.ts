...
import {
  CLASSIFIER_LEVEL_2_MOCK_DATA,
  LEVEL2_API_RESPONSE,
} from '../../../src/services/handlers/mocks/classifier-themes-level-2';
import {
  CLASSIFIER_LEVEL_1,
  LEVEL1_API_RESPONSE,
} from '../../../src/services/handlers/mocks/classifier-themes-level-1';
import {
  CLASSIFIER_LEVEL_3_MOCK_DATA,
  NO_CLASSIFIER_LEVEL_2_MOCK_DATA,
  LEVEL3_API_RESPONSE,
  LEVEL3_MISSING_CLASSIFIER_API_RESPONSE,
} from '../../../src/services/handlers/mocks/classifier-themes-level-3';

jest.mock('../../../src/config/environmentConfig', () => ({
  environmentConfig: {
    classifierApiUrl: 'https://example.com/',
    classifierApiKey: 'test-api-key',
  },
}));
