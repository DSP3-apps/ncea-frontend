...
const customHapiViews = {
  ...
  options: {
    ...
    context: {
      ...
      searchApiUrl: environmentConfig.searchApiUrl,
      categoryResultCountApiUrl: environmentConfig.categoryResultCountApiUrl,
      classifierApiUrl: environmentConfig.classifierApiUrl,
      vocabularyApiUrl: environmentConfig.vocabularyApiUrl,
      ...getPostHogConfig(),
    },
  },
};
