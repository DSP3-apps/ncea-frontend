...
import { BASE_PATH, DATA_DOWNLOADS_TYPES } from './constants';
import { capitalizeWords } from './formatAggregationResponse';
import { getOrganisationDetails } from './getOrganisationDetails';
import { isEmpty } from './isEmpty';
import { buildJwtDownloadHandler, escapeHtmlAttribute } from './queryStringHelper';
   ...
   <tr>
    ...
    <td>
      <button
        ...
        data-jwt="${escapeHtmlAttribute('')}"
        class="download-resource-jwt govuk-button copy-link-btn"
        type="button"
        onclick="${buildJwtDownloadHandler(BASE_PATH)}">
        Download
      </button>      
    </td>
  </tr>
